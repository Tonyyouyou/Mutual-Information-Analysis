...
from fairseq.modules.conformer_layer import ConformerWav2Vec2EncoderLayer, ConBimambaWav2Vec2EncoderLayer
...
LAYER_TYPE_CHOICES = ChoiceEnum(["transformer", "conformer", "trf_adp", "transbimamba", 'conbimamba'])
...
class TransformerEncoder(nn.Module):
    def build_encoder_layer(self, args: Wav2Vec2Config, **kwargs):
        ...
        elif args.layer_type == 'transbimamba':
            layer = TransBiMambaSentenceEncoderLayer(
                embedding_dim=self.embedding_dim,
                ffn_embedding_dim=args.encoder_ffn_embed_dim,
                num_attention_heads=args.encoder_attention_heads,
                dropout=self.dropout,
        ...
        elif args.layer_type == "conbimamba":
            layer = ConBimambaWav2Vec2EncoderLayer(
                embed_dim=self.embedding_dim,
                ffn_embed_dim=args.encoder_ffn_embed_dim,
                attention_heads=args.encoder_attention_heads,
                dropout=args.dropout,
...
class TransBiMambaSentenceEncoderLayer(nn.Module):
    """
    Implements a Transformer Encoder Layer used in BERT/XLM style pre-trained
    models.
    """
